...
class ProductFeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_feature" do
    assert_difference('ProductFeature.count') do
      post product_features_url, params: { product_feature: { active_status: @product_feature.active_status, name: @product_feature.name, pfeature_id: @product_feature.pfeature_id, product_id: @product_feature.product_id, sort: @product_feature.sort } }
    end
  ...
  test "should update product_feature" do
    patch product_feature_url(@product_feature), params: { product_feature: { active_status: @product_feature.active_status, name: @product_feature.name, pfeature_id: @product_feature.pfeature_id, product_id: @product_feature.product_id, sort: @product_feature.sort } }
